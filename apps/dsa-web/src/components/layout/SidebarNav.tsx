...
import { BarChart3, Bell, BriefcaseBusiness, Home, LogOut, MessageSquareQuote, Search, Settings2, Sparkles } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'recommend', labelKey: 'layout.nav.recommend', to: '/recommend', icon: Sparkles },
